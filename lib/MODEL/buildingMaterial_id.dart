...
//
//     final buldingMaterialIdModel = buldingMaterialIdModelFromJson(jsonString);

import 'dart:convert';

BuldingMaterialIdModel buldingMaterialIdModelFromJson(String str) => BuldingMaterialIdModel.fromJson(json.decode(str));

String buldingMaterialIdModelToJson(BuldingMaterialIdModel data) => json.encode(data.toJson());

class BuldingMaterialIdModel {
  int id;
  String name;
  String photoName;
  String description;
  ...
  factory BuldingMaterialIdModel.fromJson(Map<String, dynamic> json) => BuldingMaterialIdModel(
    id: json["id"],
    name: json["name"],
