...
class EditProfileSpecialtyScreen extends StatefulWidget {
  const EditProfileSpecialtyScreen({Key? key}) : super(key: key);

  @override
  State<EditProfileSpecialtyScreen> createState() =>
      _EditProfileSpecialtyScreenState();
}

class _EditProfileSpecialtyScreenState
    extends State<EditProfileSpecialtyScreen> {
  var formKey = GlobalKey<FormState>();
  final userNameController = new TextEditingController();
  final PhoneController = new TextEditingController();
  final EmailController = new TextEditingController();
  final SpecialtyController = new TextEditingController();
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        LocaleKeys.Change_Specialty.tr(),
                        style: TextStyle(
                          fontFamily: 'Tajawal2',
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            labelText: LocaleKeys.New_Specialty.tr(),
                            hintText: LocaleKeys.New_Specialty.tr(),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Edit(
                              SpecialtyController.text.toString(),
                            );
                          },
